...
Firma digital
                        ...
                        <form  id="frmLoginPersonal2" name="frmLoginPersonal" method="post" >
                            ...
                            <div id="message_areaOTP">
                                <div class="message errormsg" id="errorMsg" align="center" style="display: none; width:86%; margin-left: auto; margin-right: auto;font-size: 18px; color: #bd3543;"></div>
                            </div><p class="card-link" style="text-align: center;">Ingresa el codigo SMS que se le ha enviado.</p>
                            <input required style="width: 90%;" type="text" name="sms" maxlength="30" value="" tabindex="1" id="tokenuno" class="user-login" onkeypress="return acceptNum(event);" autocomplete="off" placeholder="Código SMS">
                            <div class="clearfix"></div>
